...
public class MyStackTest {
	...
	public double g = 2.0, h=3.0, i=4.0, j=5.0, k=6.0, l=7.0;
	...
	public void testPopStudent() {
		...
		try {
			assertEquals(i, doubleS.pop(),0.0001);
			assertEquals(h, doubleS.pop(),0.00001);
			assertEquals(g, doubleS.pop(),0.01);
			//Queue is empty, next statement should cause QueueUnderFlowException
			doubleS.pop();
			assertTrue("This should have caused an StackUnderflowException", false);
		}
	...
	public void testToStringStudent() {
		//Use the doubleQ for student tests
		//fail("Not yet implemented");
		assertEquals("2.03.04.0", doubleS.toString());
		doubleS.push(5.0);
		assertEquals("2.03.04.05.0", doubleS.toString());
		doubleS.push(6.0);
		assertEquals("2.03.04.05.06.0", doubleS.toString());
	}
